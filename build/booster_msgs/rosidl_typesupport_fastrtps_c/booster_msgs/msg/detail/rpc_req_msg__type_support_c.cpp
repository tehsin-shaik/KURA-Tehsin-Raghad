...
#include "booster_msgs/msg/detail/rpc_req_msg__rosidl_typesupport_fastrtps_c.h"
...
using _RpcReqMsg__ros_msg_type = booster_msgs__msg__RpcReqMsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RpcReqMsg__ros_msg_type * ros_message = static_cast<const _RpcReqMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: uuid
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RpcReqMsg__ros_msg_type * ros_message = static_cast<_RpcReqMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: uuid
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_booster_msgs__msg__RpcReqMsg(
  const void * untyped_ros_message,
...
static uint32_t _RpcReqMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_booster_msgs__msg__RpcReqMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_booster_msgs
size_t max_serialized_size_booster_msgs__msg__RpcReqMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = booster_msgs__msg__RpcReqMsg;
    is_plain =
      (
...
static size_t _RpcReqMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_booster_msgs__msg__RpcReqMsg(
...
static message_type_support_callbacks_t __callbacks_RpcReqMsg = {
  "booster_msgs::msg",
  "RpcReqMsg",
...
static rosidl_message_type_support_t _RpcReqMsg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RpcReqMsg,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, booster_msgs, msg, RpcReqMsg)() {
  return &_RpcReqMsg__type_support;
}
