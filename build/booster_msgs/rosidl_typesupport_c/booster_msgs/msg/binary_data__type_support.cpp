...
static const _BinaryData_type_support_symbol_names_t _BinaryData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, booster_msgs, msg, BinaryData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, booster_msgs, msg, BinaryData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, booster_msgs, msg, BinaryData)() {
  return &::booster_msgs::msg::rosidl_typesupport_c::BinaryData_message_type_support_handle;
}
