...
static const _BinaryData_type_support_symbol_names_t _BinaryData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, booster_msgs, msg, BinaryData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, booster_msgs, msg, BinaryData)),
  }
};
...
{
  return &::booster_msgs::msg::rosidl_typesupport_cpp::BinaryData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, booster_msgs, msg, BinaryData)() {
  return get_message_type_support_handle<booster_msgs::msg::BinaryData>();
}
