...
bool booster_msgs__msg__binary_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("booster_msgs.msg._binary_data.BinaryData", full_classname_dest, 40) == 0);
  }
  booster_msgs__msg__BinaryData * ros_message = _ros_message;
  {  // data
...
PyObject * booster_msgs__msg__binary_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("booster_msgs.msg._binary_data");
