...
static const _RobotInfo_type_support_symbol_names_t _RobotInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, game_controller_interface, msg, RobotInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, game_controller_interface, msg, RobotInfo)),
  }
};
...
{
  return &::game_controller_interface::msg::rosidl_typesupport_cpp::RobotInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, game_controller_interface, msg, RobotInfo)() {
  return get_message_type_support_handle<game_controller_interface::msg::RobotInfo>();
}
