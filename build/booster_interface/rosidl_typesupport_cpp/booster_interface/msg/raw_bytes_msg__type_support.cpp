...
static const _RawBytesMsg_type_support_symbol_names_t _RawBytesMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, booster_interface, msg, RawBytesMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, booster_interface, msg, RawBytesMsg)),
  }
};
...
{
  return &::booster_interface::msg::rosidl_typesupport_cpp::RawBytesMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, booster_interface, msg, RawBytesMsg)() {
  return get_message_type_support_handle<booster_interface::msg::RawBytesMsg>();
}
