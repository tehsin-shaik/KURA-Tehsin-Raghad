...
#include "booster_interface/msg/detail/motor_state__rosidl_typesupport_fastrtps_c.h"
...
using _MotorState__ros_msg_type = booster_interface__msg__MotorState;
...
static uint32_t _MotorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_booster_interface__msg__MotorState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = booster_interface__msg__MotorState;
    is_plain =
      (
...
static size_t _MotorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_booster_interface__msg__MotorState(
