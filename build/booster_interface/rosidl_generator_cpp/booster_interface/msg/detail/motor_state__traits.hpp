...
#ifndef BOOSTER_INTERFACE__MSG__DETAIL__MOTOR_STATE__TRAITS_HPP_
#define BOOSTER_INTERFACE__MSG__DETAIL__MOTOR_STATE__TRAITS_HPP_
...
inline void to_yaml(
  const booster_interface::msg::MotorState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const booster_interface::msg::MotorState & msg)
{
  return booster_interface::msg::to_yaml(msg);
}

template<>
inline const char * data_type<booster_interface::msg::MotorState>()
{
  return "booster_interface::msg::MotorState";
}

template<>
inline const char * name<booster_interface::msg::MotorState>()
{
  return "booster_interface/msg/MotorState";
}

template<>
struct has_fixed_size<booster_interface::msg::MotorState>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<booster_interface::msg::MotorState>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<booster_interface::msg::MotorState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BOOSTER_INTERFACE__MSG__DETAIL__MOTOR_STATE__TRAITS_HPP_
