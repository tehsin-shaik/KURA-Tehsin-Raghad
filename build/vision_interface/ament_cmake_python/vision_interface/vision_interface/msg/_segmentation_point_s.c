...
bool vision_interface__msg__segmentation_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_interface.msg._segmentation_point.SegmentationPoint", full_classname_dest, 58) == 0);
  }
  vision_interface__msg__SegmentationPoint * ros_message = _ros_message;
  {  // label
...
{
  /* NOTE(esteve): Call constructor of SegmentationPoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_interface.msg._segmentation_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SegmentationPoint");
