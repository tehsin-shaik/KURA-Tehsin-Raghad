...
#include "vision_interface/msg/detail/segmentation_line__rosidl_typesupport_fastrtps_c.h"
...
using _SegmentationLine__ros_msg_type = vision_interface__msg__SegmentationLine;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SegmentationLine__ros_msg_type * ros_message = static_cast<const _SegmentationLine__ros_msg_type *>(untyped_ros_message);
  // Field name: label
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SegmentationLine__ros_msg_type * ros_message = static_cast<_SegmentationLine__ros_msg_type *>(untyped_ros_message);
  // Field name: label
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _SegmentationLine__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_interface__msg__SegmentationLine(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_interface__msg__SegmentationLine;
    is_plain =
      (
...
static size_t _SegmentationLine__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vision_interface__msg__SegmentationLine(
...
static message_type_support_callbacks_t __callbacks_SegmentationLine = {
...
static rosidl_message_type_support_t _SegmentationLine__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SegmentationLine,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_interface, msg, SegmentationLine)() {
  return &_SegmentationLine__type_support;
}
