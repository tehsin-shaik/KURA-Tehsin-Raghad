...
#include "vision_interface/msg/detail/ball__rosidl_typesupport_fastrtps_c.h"
...
using _Ball__ros_msg_type = vision_interface__msg__Ball;
...
size_t get_serialized_size_vision_interface__msg__Ball(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Ball__ros_msg_type * ros_message = static_cast<const _Ball__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Ball__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_interface__msg__Ball(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_interface
size_t max_serialized_size_vision_interface__msg__Ball(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_interface__msg__Ball;
    is_plain =
      (
...
static size_t _Ball__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vision_interface__msg__Ball(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_interface, msg, Ball)() {
