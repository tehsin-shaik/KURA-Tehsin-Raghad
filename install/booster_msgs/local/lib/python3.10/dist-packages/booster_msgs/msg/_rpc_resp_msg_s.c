...
bool booster_msgs__msg__rpc_resp_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("booster_msgs.msg._rpc_resp_msg.RpcRespMsg", full_classname_dest, 41) == 0);
  }
  booster_msgs__msg__RpcRespMsg * ros_message = _ros_message;
  {  // uuid
...
{
  /* NOTE(esteve): Call constructor of RpcRespMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("booster_msgs.msg._rpc_resp_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RpcRespMsg");
