...
booster_msgs__msg__RpcReqMsg__init(booster_msgs__msg__RpcReqMsg * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->uuid)) {
    booster_msgs__msg__RpcReqMsg__fini(msg);
    return false;
  }
  // header
...
booster_msgs__msg__RpcReqMsg__create()
{
  ...
  booster_msgs__msg__RpcReqMsg * msg = (booster_msgs__msg__RpcReqMsg *)allocator.allocate(sizeof(booster_msgs__msg__RpcReqMsg), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(booster_msgs__msg__RpcReqMsg));
  bool success = booster_msgs__msg__RpcReqMsg__init(msg);
  if (!success) {
...
booster_msgs__msg__RpcReqMsg__Sequence__init(booster_msgs__msg__RpcReqMsg__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  booster_msgs__msg__RpcReqMsg * data = NULL;

  if (size) {
    data = (booster_msgs__msg__RpcReqMsg *)allocator.zero_allocate(size, sizeof(booster_msgs__msg__RpcReqMsg), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = booster_msgs__msg__RpcReqMsg__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        booster_msgs__msg__RpcReqMsg__fini(&data[i - 1]);
      }
...
booster_msgs__msg__RpcReqMsg__Sequence__fini(booster_msgs__msg__RpcReqMsg__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      booster_msgs__msg__RpcReqMsg__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  booster_msgs__msg__RpcReqMsg__Sequence * array = (booster_msgs__msg__RpcReqMsg__Sequence *)allocator.allocate(sizeof(booster_msgs__msg__RpcReqMsg__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = booster_msgs__msg__RpcReqMsg__Sequence__init(array, size);
  if (!success) {
...
booster_msgs__msg__RpcReqMsg__Sequence__destroy(booster_msgs__msg__RpcReqMsg__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    booster_msgs__msg__RpcReqMsg__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
booster_msgs__msg__RpcReqMsg__Sequence__are_equal(const booster_msgs__msg__RpcReqMsg__Sequence * lhs, const booster_msgs__msg__RpcReqMsg__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!booster_msgs__msg__RpcReqMsg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  booster_msgs__msg__RpcReqMsg__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(booster_msgs__msg__RpcReqMsg);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    booster_msgs__msg__RpcReqMsg * data =
      (booster_msgs__msg__RpcReqMsg *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!booster_msgs__msg__RpcReqMsg__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          booster_msgs__msg__RpcReqMsg__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!booster_msgs__msg__RpcReqMsg__copy(
