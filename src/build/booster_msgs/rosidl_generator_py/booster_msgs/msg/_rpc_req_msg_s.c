...
bool booster_msgs__msg__rpc_req_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("booster_msgs.msg._rpc_req_msg.RpcReqMsg", full_classname_dest, 39) == 0);
  }
  booster_msgs__msg__RpcReqMsg * ros_message = _ros_message;
  {  // uuid
...
{
  /* NOTE(esteve): Call constructor of RpcReqMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("booster_msgs.msg._rpc_req_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RpcReqMsg");
