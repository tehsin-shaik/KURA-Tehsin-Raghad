...
static const _Kick_type_support_symbol_names_t _Kick_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, brain, msg, Kick)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, brain, msg, Kick)),
  }
};
...
{
  return &::brain::msg::rosidl_typesupport_cpp::Kick_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, brain, msg, Kick)() {
  return get_message_type_support_handle<brain::msg::Kick>();
}
