...
static const _ButtonEventMsg_type_support_symbol_names_t _ButtonEventMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, booster_interface, msg, ButtonEventMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, booster_interface, msg, ButtonEventMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, booster_interface, msg, ButtonEventMsg)() {
  return &::booster_interface::msg::rosidl_typesupport_c::ButtonEventMsg_message_type_support_handle;
}
