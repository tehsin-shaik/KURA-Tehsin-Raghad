...
bool booster_interface__msg__booster_api_resp_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("booster_interface.msg._booster_api_resp_msg.BoosterApiRespMsg", full_classname_dest, 61) == 0);
  }
  booster_interface__msg__BoosterApiRespMsg * ros_message = _ros_message;
  {  // status
...
{
  /* NOTE(esteve): Call constructor of BoosterApiRespMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("booster_interface.msg._booster_api_resp_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoosterApiRespMsg");
