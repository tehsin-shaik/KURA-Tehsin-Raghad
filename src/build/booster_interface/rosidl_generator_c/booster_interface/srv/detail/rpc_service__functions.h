...
#ifndef BOOSTER_INTERFACE__SRV__DETAIL__RPC_SERVICE__FUNCTIONS_H_
#define BOOSTER_INTERFACE__SRV__DETAIL__RPC_SERVICE__FUNCTIONS_H_
...
/// Initialize srv/RpcService message.
/**
...
/// Finalize srv/RpcService message.
/**
...
/// Create srv/RpcService message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * booster_interface__srv__RpcService_Request__init().
...
/// Destroy srv/RpcService message.
/**
 * It calls
 * booster_interface__srv__RpcService_Request__fini()
...
/// Check for srv/RpcService message equality.
/**
...
/// Initialize array of srv/RpcService messages.
/**
...
/// Finalize array of srv/RpcService messages.
/**
 * It calls
 * booster_interface__srv__RpcService_Request__fini()
...
/// Create array of srv/RpcService messages.
/**
 * It allocates the memory for the array and calls
 * booster_interface__srv__RpcService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RpcService messages.
/**
 * It calls
 * booster_interface__srv__RpcService_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RpcService message array equality.
/**
...
/// Copy an array of srv/RpcService messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * booster_interface__srv__RpcService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_booster_interface
...
/**
 * It calls
 * booster_interface__srv__RpcService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_booster_interface
...
/**
 * It allocates the memory for the array and calls
 * booster_interface__srv__RpcService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_booster_interface
...
/**
 * It calls
 * booster_interface__srv__RpcService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BOOSTER_INTERFACE__SRV__DETAIL__RPC_SERVICE__FUNCTIONS_H_
