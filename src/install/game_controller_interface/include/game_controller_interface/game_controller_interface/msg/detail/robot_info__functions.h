...
#ifndef GAME_CONTROLLER_INTERFACE__MSG__DETAIL__ROBOT_INFO__FUNCTIONS_H_
#define GAME_CONTROLLER_INTERFACE__MSG__DETAIL__ROBOT_INFO__FUNCTIONS_H_
 ...
 * calls
 * game_controller_interface__msg__RobotInfo__init().
...
/**
 * It calls
 * game_controller_interface__msg__RobotInfo__fini()
 ...
 * game_controller_interface__msg__RobotInfo__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * game_controller_interface__msg__RobotInfo__Sequence__fini()
 * on the array,
...
#endif  // GAME_CONTROLLER_INTERFACE__MSG__DETAIL__ROBOT_INFO__FUNCTIONS_H_
