...
#ifndef VISION_INTERFACE__MSG__DETAIL__DETECTIONS_TRACK__TRAITS_HPP_
#define VISION_INTERFACE__MSG__DETAIL__DETECTIONS_TRACK__TRAITS_HPP_
...
inline std::string to_yaml(const DetectionsTrack & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const vision_interface::msg::DetectionsTrack & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const vision_interface::msg::DetectionsTrack & msg)
{
  return vision_interface::msg::to_yaml(msg);
}

template<>
inline const char * data_type<vision_interface::msg::DetectionsTrack>()
{
  return "vision_interface::msg::DetectionsTrack";
}

template<>
inline const char * name<vision_interface::msg::DetectionsTrack>()
{
  return "vision_interface/msg/DetectionsTrack";
}

template<>
struct has_fixed_size<vision_interface::msg::DetectionsTrack>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<vision_interface::msg::DetectionsTrack>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<vision_interface::msg::DetectionsTrack>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // VISION_INTERFACE__MSG__DETAIL__DETECTIONS_TRACK__TRAITS_HPP_
